window.onload = function(){
	...
	// mobile.setAttribute("id","mobile-nav");
	...
	document.getElementById('mobile-nav').onclick = function(){
		...
		if(a){
			...
			document.getElementById('mobile-nav').style.backgroundImage='url(../images/mobile-menu.png)';
		} else {
	...
	submenu = function (i){
		...
		if(b){
			...
			getElm[i].lastChild.style.backgroundImage='url(../images/mobile-menu.png)';
